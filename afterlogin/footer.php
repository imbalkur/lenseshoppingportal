...
<div class="container">
  <div class="row">
    ...
    <form action="footer.php" method="POST" class="formcontact">
      <input class="box" type="hidden" value="user" required name="name">
      <input class="box" type="hidden" value="<?php echo $email;?>" required name="email"><br />
...
?>
    ...
    <br /><a href="womensunglasses.php">Sunglasses</a><br />
    <br /><br />
    Men<br />
    <a href="meneyeglasses.php">Eyeglasses</a><br />
    <a href="mensunglasses.php">Sunglasses</a><br />
    <br />
