                ...
                while ($row = mysqli_fetch_array($result)) { ?>
                    <div class="col-md-3">
                        <form method="post" action="cart.php?action=add&id=<?php echo $row["pid"]; ?>">
							...
							<select class="custom-select my-1 mr-sm-2 form-control" id="FormControl" name="thickness" required disabled>
							...
							<select class="custom-select my-1 mr-sm-2 form-control" id="FormControl" name="lenstype" required disabled>
