	...
	<nav class="navbar fixed-top navbar-expand-xl" style="background-image: linear-gradient(to right,#850df9, #0f149d);">
		...
		<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
		  <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle Men" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			  Eyeglasses
			</a>
		  ...
		  <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle women" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			 Sunglasses
			</a>
			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		  ...
		  <li class="nav-item">
			<a class="nav-link others" href="contacts.php" role="button">
			 Contacts 
			</a>
		  </li>
		   <li class="nav-item">
			<a class="nav-link others" href="about.php" role="button">
			 &nbsp;&nbsp;Help
			</a>
		  </li>
		</ul>
		...
		<ul class="navbar-nav mt-2 mt-lg-0">
		 <li class="nav-item" >
			<a class="nav-link" href="login.php" role="button"><span class="glyphicon glyphicon-shopping-cart"></span>
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			  <a type="button" class="dropdown-item" href="login.php">Login</a>
